...
export const sendVerificationEmail = (email, name, url) => {
    ...
    const mailOptions = {
        ...
        text: "test email",
        html: `<div style=" padding: 2ch"> <h1 style="color: blue">facebook</h1> Action requise: Activate your facebook account </div> <div style="border-bottom: 1px solid; padding: 2ch"> <span>Hello ${name}</span> </div> <div style=" padding: 2ch"> <span >You recently created an account on Facebook. To complete your registration, pleace confirm your account.</span > </div> <div> <a href=${url} style=" margin: 1ch; width: 230px; padding: 10px 15px; background-color: rgb(45, 45, 203); border: 2px solid; display: block; font-size: large; color: aliceblue; border-radius: 2ch; " >Confirm your account</a > </div>`
